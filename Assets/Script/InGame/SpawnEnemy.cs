...
public class SpawnEnemy : MonoBehaviour
{
    ...
    {
        StartCoroutine(Spawn(5,pos.position,30,(int)PooledIndex.GreenSlime));
    }
    public void SpawnRedSlime(Transform pos)
    {
        StartCoroutine(Spawn(10,pos.position,50,(int)PooledIndex.RedSlime));
    }
    public void SpawnBlueSlime(Transform pos)
    {
        StartCoroutine(Spawn(10,pos.position,50,(int)PooledIndex.BlueSlime));
    }
